...
function short_Links(link, tokenLink) {
    $.post("/short_links", { link: link, tokenLink: tokenLink, grecaptcha: grecaptcha.getResponse() })
        .done(function (ketqua) {
    ...
    $("#Getquicklink").click(function () {
        ...
        if (link.length != 0) {
            if (tokenLink.length != 0) {
                $.post("/verify_token_link_exist", { tokenLink: tokenLink })
                    .done(function (ketqua) {
