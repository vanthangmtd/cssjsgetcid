...
function showAlert(messageAlert, messageText) {
    var alertBox = '<div class="alert alert-' + messageAlert + ' alert-dismissable" id="showalert"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + messageText + '</div>';
...
function checklinkcustom(checklinkcustom) {
...
$(document).ready(function () {
    ...
    $("#linkcustom").on('keyup', function () {
        $("#linkquick").val("https://getcid.info/"+$(this).val());
    });
